...
<body>
  <header>
		...
		<div class="menu">
			...
			<a href="RegistroV.jsp">Registrarse</a>
</div>
          </header>
     <center> <h2>.</h2> </center>

    <form action="InicioV.jsp" method="post">
        <center> <h2>Inicio Sesion ADMIN</h2> </center>
...
<%
    ...
    if (correo != null && contrasena != null) {
        ...
        String sql = "SELECT * FROM Vendedores WHERE CorreoV = ? AND ContrasenaV = ?";
