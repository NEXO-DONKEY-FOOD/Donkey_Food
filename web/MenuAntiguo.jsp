...
<body>
  ...
  <li>
                ...
                <!-- ***** Barra Del buscador ***** -->
                 ...
                 <input placeholder="Search" type="search" name="Nombre"class="input">
                 <button>🔎</button>
                 </form>
                <!-- ***** Menu End ***** -->
         <style>
...
<body>
    <h1>Claro tenemos estos productos <%= session.getAttribute("correo") %></h1>
</body>
</html>
  ...
  <% 
          ...
          <a onclick="abrirVentana()">Pedir</a>
           </div>
