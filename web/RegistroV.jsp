...
<%
    ...
    try {
        ...
        stmt = conn.prepareStatement("INSERT INTO Vendedores (CorreoV, NombreV, ContrasenaV) VALUES (?, ?, ?)");
...
<body>
    <header>
		...
		<div class="menu">
			...
			<a href="InicioU.jsp">Usuario</a>
			<a href="InicioV.jsp">IniciarSesion</a>
</div>
          </header>
   ...
   <center> <h2>.</h2> </center>
    ...
    <form action="RegistroV.jsp" method="post">
        <center> <h2>Registro de vendedor</h2> </center>
        <p>
